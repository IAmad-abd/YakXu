                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://discord.com/invite/yakucorp"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://twitter.com/YakuCorp"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        YAKU X is the customizable playable avatar of the
                                                        Yakuverse - Travel the Yakuverse, buy properties,
                                                        vehicles, clothing and more... Meet other Web3
                                                        communities in a cyberpunk universe and enjoy
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">94%</b> (6580/7000)
                          </span>
                        </div>
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                Imagine a world where all Web3 communities
                                                                would be united, where you could own
                                                                properties that generate income, where you
                                                                would be a shareholder on sales. This world is
                                                                called the Yakuverse, a cyberpunk universe that
                                                                you can roam with your Avatar.
                        ...
                        <div className="tw-p-4">
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Q1 The rise of Yakuverse - All is done and overdelivered
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        Launch land sales and community access to Monke DAO, Stoned
                                                                        Ape Crew and more... (initially on Q2)


                                                                        Launch of $YAKU Token and official partnership with Magic Eden
                                                                        (initially on Q2)


                                                                        Staking, Raffle, Auctions (was not in the OG roadmap)


                                                                        Integration and official partnership with Monke DAO, Stoned APE
                                                                        Crew, Audius, Magic Eden, Hawksight and more...
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Q2 The expansion of the Yakuverse
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        Development of a PlayToEarn Game
                            </p>
                            <br />
                          </div>
